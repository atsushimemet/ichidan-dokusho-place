# Render デプロイ手順書（Neon DB使用）

## 📋 概要

このドキュメントでは、ichidan-dokusho-placeアプリケーションをRenderにデプロイし、Neonデータベースを使用する手順を説明します。
...
#### 4.2 フロントエンド環境変数設定
1. Renderダッシュボードでフロントエンドサービスを選択
2. 「Environment」タブをクリック
3. 以下の環境変数を追加：
